...
# 나빌 입력기 개선 for emacs-plus
* emacs 사용때 시스템입력소스(navilIME) 영문으로 자동전환: 가장 큰 불편
...
# 도움
* 저는 개발자가 아닙니다.한글자판을 사용하는 사용자가 한영전환에 관한 불편사항을 개선하고자 시작
* 다행히도 좋은 시대를 만나 AI 도움으로 개인 불편사항 해결


# 빌드
* swift version 5 필수.(현재의 ver6 에러)
```
